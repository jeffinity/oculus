...
func NewGRPCServer(c *conf.Bootstrap, hs *service.HealthService, bs *service.BookkeepingService, logger log.Logger) *grpc.Server {
	...
	bookkeepingv1.RegisterBookkeepingServiceServer(srv, bs)
	return srv
}
