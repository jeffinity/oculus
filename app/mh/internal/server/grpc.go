...
func NewGRPCServer(c *conf.Bootstrap, hs *service.HealthService, cs *service.ComicService, logger log.Logger) *grpc.Server {
	...
	mhv1.RegisterMHComicServiceServer(srv, cs)
	return srv
}
